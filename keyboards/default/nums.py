...
digits.add(KeyboardButton(text="Savatcha 🧰"), KeyboardButton(text="Orqaga"))

contact = ReplyKeyboardMarkup(resize_keyboard=True, keyboard=[[KeyboardButton(text="✅  Raqamni tasdiqlash", request_contact=True)]])

location = ReplyKeyboardMarkup(resize_keyboard=True, keyboard=[[KeyboardButton(text="📍 Joylashuvi", request_location=True)]])